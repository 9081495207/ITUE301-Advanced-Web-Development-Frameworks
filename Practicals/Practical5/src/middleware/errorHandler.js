 ...
 * Formats raw Mongoose errors (ValidationError, CastError) into clean, structured JSON responses.
 */
const globalErrorHandler = (err, req, res, next) => {
  console.error("🔥 [Global Error Handler]:", err.name, err.message);

  // Handle Mongoose Schema Validation Errors (e.g. required field missing)
  ...
  // Handle Mongoose CastError (e.g. invalid ObjectId format cast)
